import { ExclamationCircleOutlined, QuestionCircleOutlined } from '@oceanbase/icons';
...
const InternalIconTip = (props: IProps) => {
  const { content, tip, className, style, size, contentProps, tipProps, iconProps, icon } = props;
...
const BaseTip = (props: Omit<IProps, 'tip' | 'tipProps'>) => {
  const { content, size, className, style, contentProps, iconProps, icon } = props;
