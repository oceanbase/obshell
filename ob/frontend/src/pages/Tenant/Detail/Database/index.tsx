...
import { deleteDatabase, listDatabases } from '@/service/obshell/tenant';
...
import { connect, history, useParams, useSelector } from '@umijs/max';
...
const Database: React.FC<DatabaseProps> = ({ tenantData }) => {
