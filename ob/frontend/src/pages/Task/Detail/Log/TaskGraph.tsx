...
import { Dropdown, Menu, Space, theme, token, Tooltip, Typography } from '@oceanbase/design';
...
export interface TaskGraphProps {
  taskData?: API.DagDetailDTO;
  onOperationSuccess: () => void;
  subtask?: API.SubtaskInstance;
  onSubtaskChange: (domId: string | undefined) => void;
}
...
const TaskGraph: React.FC<TaskGraphProps> = React.forwardRef<TaskGraphRef, TaskGraphProps>(
  ({ taskData, onOperationSuccess, subtask, onSubtaskChange }, ref) => {
    ...
    // 定位到目标节点
    const setTargetSubtask = (targetSubtaskId?: string) => {
          ...
          style={{
            ...
            ...(getTaskDomId(node) === subtask?.domId
              ? {
                  ...
                  // issue: https://aone.alipay.com/issue/38542969
                  paddingRight: 11,
                }
              : {}),
          }}
