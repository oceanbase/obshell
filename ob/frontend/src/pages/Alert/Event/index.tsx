...
export default function Event() {
  ...
  const columns: ColumnsType<API.Alert> = [
    ...
    {
      title: formatMessage({ id: 'OBShell.Alert.Event.AlarmObject', defaultMessage: '告警对象' }),
      dataIndex: 'instance',
      key: 'instance',
      render: instance => (
        <Text>
          {formatMessage({ id: 'OBShell.Alert.Event.Object', defaultMessage: '对象：' })}
          {instance[instance.type]}
          <br />
          {formatMessage({ id: 'OBShell.Alert.Event.Type', defaultMessage: '类型：' })}
          {instance.type}
        </Text>
      ),
    },
