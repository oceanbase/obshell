...
var (
	...
	ErrObTenantPasswordCacheSyncFailed           = NewErrorCode("OB.Tenant.PasswordCacheSyncFailed", unexpected, "err.ob.tenant.password.cache.sync.failed")
	...
	ErrObUpgradeTenantsSchemaNotRefreshed = NewErrorCode("OB.Upgrade.TenantsSchemaNotRefreshed", illegalArgument, "err.ob.upgrade.tenants.schema.not.refreshed")
	ErrObUpgradeTabletInMerging           = NewErrorCode("OB.Upgrade.TabletInMerging", illegalArgument, "err.ob.upgrade.tablet.in.merging")
	ErrObUpgradeTenantInMajorCompaction   = NewErrorCode("OB.Upgrade.TenantInMajorCompaction", illegalArgument, "err.ob.upgrade.tenant.in.major.compaction")
	ErrObUpgradeMinObserverVersionNotSync = NewErrorCode("OB.Upgrade.MinObserverVersionNotSync", illegalArgument, "err.ob.upgrade.min.observer.version.not.sync")
	ErrObUpgradeTenantCompatibleNotSync   = NewErrorCode("OB.Upgrade.TenantCompatibleNotSync", illegalArgument, "err.ob.upgrade.tenant.compatible.not.sync")
	ErrObUpgradeHasRunningBackupTask      = NewErrorCode("OB.Upgrade.HasRunningBackupTask", illegalArgument, "err.ob.upgrade.has.running.backup.task")
	...
	ErrAgentStartForOceanbaseSeekdbIncorrectly = NewErrorCode("Agent.Start.ForOceanbaseSeekdb.Incorrectly", illegalArgument, "err.agent.start.for.oceanbase.seekdb.incorrectly")
	...
	ErrSecurityAuthenticationHeaderDecryptFailed         = NewErrorCode("Security.Authentication.Header.DecryptFailed", unauthorized, "err.security.authentication.header.decrypt.failed", 1)
