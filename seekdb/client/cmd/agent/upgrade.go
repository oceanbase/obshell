...
import (
	...
	rpmutil "github.com/oceanbase/obshell/seekdb/client/utils/rpm"
...
func newUpgradeCmd() *cobra.Command {
	...
	upgradeCmd := command.NewCommand(&cobra.Command{
		Use:     CMD_UPGRADE,
		Short:   "Upgrade the obshell agent to the specified version.",
...
func uploadPkgsByNameInDir(params *param.UpgradeCheckParam, pkgDir string, pkgs map[string]*rpm.Package) (err error) {
	...
	return uploadPkgsByNameAndVersionInDir(pkgDir, pkgs, constant.VERSION_RELEASE, params.Version, params.Release, true)
}
...
func upgradeCmdExample() string {
	return `  obshell agent upgrade -d /home/oceanbase/upgrade/ --seekdb
