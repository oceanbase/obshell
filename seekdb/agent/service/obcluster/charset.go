...
func (*ObserverService) GetAllCharsets() (charsets []oceanbase.ObCharset, err error) {
...
func (*ObserverService) GetAllCollations() (collations []oceanbase.ObCollation, err error) {
	oceanbaseDb, err := oceanbasedb.GetInstance()
	if err != nil {
		return nil, err
	}
