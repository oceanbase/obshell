...
import (
	...
	agentlog "github.com/oceanbase/obshell/seekdb/agent/log"
...
func (a *Agent) initAgent() (err error) {
	...
	if a.obHasStarted {
		if !a.upgradeMode {
			if err = observer.LoadOBConfigFromConfigFile(); err != nil {
		...
		return errors.Occur(errors.ErrAgentNeedToTakeOver)
	}
...
func (a *Agent) isOBhasStarted() bool {
	...
	a.obHasStarted, _ = observer.HasStarted()
