...
import { modifyGlobalPrivilege, modifyDbPrivilege, createUser } from '@/service/obshell/user';

import { listDatabases } from '@/service/obshell/database';
...
const AddUserDrawer: React.FC<AddOrEditUserDrawerProps> = ({
  ...
  const { data: databaseListData, loading: databaseListLoading } = useRequest(listDatabases, {
    manual: false,
  });
