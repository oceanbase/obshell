...
export const BOOLEAN_LIST = [
  {
    label: formatMessage({ id: 'ocp-express.src.constant.Is', defaultMessage: '是' }),
    value: true,
  },

  {
    label: formatMessage({ id: 'ocp-express.src.constant.No', defaultMessage: '否' }),
    value: false,
  },
];
...
export const DESKTOP_UI_MODE = 'DESKTOP_UI_MODE';
export const DESKTOP_WINDOW = 'DESKTOP_WINDOW';
