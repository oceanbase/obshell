...
/** get agent last maintenance dag get agent last maintenance dag GET /api/v1/task/dag/maintain/agents */
export async function getAllAgentsLastMaintenanceDag(options?: { [key: string]: any }) {
  return request<API.OcsAgentResponse & { data?: API.DagDetailDTO[] }>(
    '/api/v1/task/dag/maintain/agents',
    {
      method: 'GET',
      ...(options || {}),
    }
